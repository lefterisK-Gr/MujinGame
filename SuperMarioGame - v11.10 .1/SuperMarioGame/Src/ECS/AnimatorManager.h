...
public:
	...
	AnimatorManager()
	{
		Animation p1idle = Animation(6, 2, 1, 0.01, "looped");
		Animation p1walk = Animation(0, 2, 3, 0.01, "looped");
		Animation p1jump = Animation(4, 2, 1, 0.01, "looped");
		Animation p2idle = Animation(6, 8, 1, 0.01, "looped");
		Animation p2walk = Animation(0, 8, 3, 0.01, "looped");
		Animation p2jump = Animation(4, 8, 1, 0.01, "looped");
